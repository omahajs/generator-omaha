...
module.exports = class extends Generator {
    ...
    prompting() {
        ...
        if (options.defaults || customPortSelected) {
            ...
            return generator.prompt(prompts).then(function (answers) {
                assign(generator, pick(answers, ['httpPort', 'httpsPort', 'websocketPort', 'markdownSupport']));
            }.bind(this));
        }
    }
    configuring() {
    ...
    writing() {
        ...
        generator.fs.copy(generator.templatePath('ssl/**/*.*'), generator.destinationPath('web/ssl'));
        //
