...
module.exports = class extends Generator {
    ...
    writing() {
        ...
        maybeInclude(useAmd, [['_config.js', `${appDirectory}config.js`]])).forEach(data => copyTpl(...data, generator));
        //
    ...
    install() {
        ...
        // Save configuration
        //
        const projectParameters = assign(config.get('projectParameters'), pick(generator, ['moduleFormat', 'useAmd', 'useAria', 'useBrowserify', 'useHandlebars', 'useImagemin', 'useLess', 'useSass']));
